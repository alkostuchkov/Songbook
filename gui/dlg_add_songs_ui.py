...
class Ui_dlg_add_songs(object):
    def setupUi(self, dlg_add_songs):
        ...
        self.hl_song_image = QHBoxLayout()
        ...
        self.hl_song_image.addItem(self.horizontalSpacer_7)


        self.verticalLayout_2.addLayout(self.hl_song_image)
        ...
        sizePolicy2.setHeightForWidth(self.btn_add_song.sizePolicy().hasHeightForWidth())
